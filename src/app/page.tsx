...
export default function HomePage() {
  ...
  return (
    <PageTransition transitionType="purple">
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-black via-[#392e5c] to-[#6441a5] p-4">
        <form onSubmit={handleSubmit} className="container max-w-md flex flex-col items-center justify-center gap-8 px-4 sm:px-8 py-8 sm:py-12 mx-auto rounded-3xl bg-black/20 backdrop-blur-md shadow-2xl shadow-purple-500/20 border border-white/10">
